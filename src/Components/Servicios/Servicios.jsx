...
export default function Servicios() {
    ...
    const [subcategorias, setSubcategorias] = useState([]); // Nuevo estado para subcategorías
    const [tipoSeleccionado, setTipoSeleccionado] = useState(null); // Nuevo estado para tipo seleccionado
    const [categoriaSeleccionada, setCategoriaSeleccionada] = useState(null); // Nuevo estado para categoría seleccionada
